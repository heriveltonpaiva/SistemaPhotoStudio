...
public class FotografoService {
    ...
    bairroDao = new BairroDao();
       ...
       public void adicionarUsuario(Fotografo usuario, Endereco endereco, Bairro bairro, Cidade cidade, Estado estado, Contato contato){
	   ...
	   //ADICIONANDO NOVO CONTATO	
		...
		fotografoDao.insert(novoUsuario);
